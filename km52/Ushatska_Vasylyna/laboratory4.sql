...
END;
   3. Створити курсор, параметер котрого це ім'я предмету, який в консоль виводить імена всіх студентів, у яких є зошит з таким предметом 
   та кількість їх нотатків
