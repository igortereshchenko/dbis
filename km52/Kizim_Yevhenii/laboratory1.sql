...
INSERT INTO FACULTIES (FACULTY_ID, FACULTY_NAME, FACLULTY_DATE_FOUNDATION, UNIVER_ID_FK) 
VALUES (3, 'Faculty of Svarka', TO_DATE('1901-01-01', 'yyyy-mm-dd'), 1);

-- EXTRA INSERTS FOR BEAUTIFUL DASHBOARD --
INSERT INTO FACULTIES (FACULTY_ID, FACULTY_NAME, FACLULTY_DATE_FOUNDATION, UNIVER_ID_FK) 
VALUES (4, 'Faculty of Cybernetics', TO_DATE('1964-01-01', 'yyyy-mm-dd'), 2);
INSERT INTO FACULTIES (FACULTY_ID, FACULTY_NAME, FACLULTY_DATE_FOUNDATION, UNIVER_ID_FK) 
VALUES (5, 'Faculty of Mechanics and Maths', TO_DATE('1964-01-01', 'yyyy-mm-dd'), 2);

INSERT INTO FACULTIES (FACULTY_ID, FACULTY_NAME, FACLULTY_DATE_FOUNDATION, UNIVER_ID_FK) 
VALUES (6, 'Faculty of Varenychky', TO_DATE('1991-01-01', 'yyyy-mm-dd'), 3);
INSERT INTO FACULTIES (FACULTY_ID, FACULTY_NAME, FACLULTY_DATE_FOUNDATION, UNIVER_ID_FK) 
VALUES (7, 'Faculty of Junior Eagles', TO_DATE('1991-01-01', 'yyyy-mm-dd'), 3);
...
INSERT INTO DEANERIES (DEANERY_ID, DEAN, DEANERY_ADDR, DEANERY_PHONE)
VALUES (2, 'David Ivanovich Bowie', 'Prospect Peremohy, 37K18', 88005553535); 
INSERT INTO FACULTY_DEAN (DEANERY_ID_FK, FACULTY_ID_FK)
VALUES(2,2);
