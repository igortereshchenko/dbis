...
with open(filename, newline='') as file:
    ...
    insert_query = "insert into Human(human_id, human_name, human_surname) values (:human_id, :human_name, :human_surname )"
    cursor_human= connection.cursor()
    cursor_human.execute(insert_query, human_id = id, human_name = name, human_surname = surname)
    cursor_human.close()
